        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden p-6">
            <form wire:submit.prevent="save">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="photo" class="block text-gray-700 dark:text-gray-300 font-bold mb-2">Foto</label>
                            <input type="file" wire:model="photo" id="photo" class="w-full text-gray-500 dark:text-gray-400">
                            <div wire:loading wire:target="photo" class="text-sm text-gray-500 mt-1">Uploading...</div>
                            @if ($photo)
                                <div class="mt-2">
                                    <img src="{{ $photo->temporaryUrl() }}" class="h-24 w-24 object-cover rounded-full">
                                </div>
                            @endif
                        ...
                        <div>
                            <label for="video" class="block text-gray-700 dark:text-gray-300 font-bold mb-2">Video Upload (Opsional)</label>
                            <input type="file" wire:model="video" id="video" class="w-full text-gray-500 dark:text-gray-400">
                            <div wire:loading wire:target="video" class="text-sm text-gray-500 mt-1">Uploading...</div>
                        ...
                        <div>
                            ...
                            <input type="url" wire:model="youtube_url" id="youtube_url" placeholder="https://youtube.com/..." class="w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white">
