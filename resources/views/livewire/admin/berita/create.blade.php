<div class="py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Tambah Berita</h1>
        </div>
            ...
            <form wire:submit.prevent="save">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            document.addEventListener('livewire:navigated', () => {
                                const initEditor = () => {
                                    if (typeof EditorJS !== 'undefined') {
                                        ...
                                        // Clean up the container manually just in case
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label for="image" class="block text-gray-700 dark:text-gray-300 font-bold mb-2">Gambar Sampul</label>
                            ...
                            @if ($image)
                                <div class="mt-2">
                                    <img src="{{ $image->temporaryUrl() }}" class="w-full h-auto object-cover rounded">
                                </div>
                            @endif
