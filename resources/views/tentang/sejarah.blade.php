{{-- 
    File: resources/views/tentang/sejarah.blade.php
    Deskripsi: Halaman untuk menampilkan sejarah perpustakaan dari database.
--}}
...
<div class="bg-white">
    <div class="mx-auto max-w-7xl px-6 lg:px-8 py-16 sm:py-24">
        ...
        <div class="mx-auto max-w-3xl text-center mt-10">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Sejarah Perpustakaan</h2>
        </div>

        {{-- Konten Sejarah dengan Timeline --}}
            ...
            <div class="-my-8">
                ...
                @empty
                    <div class="text-center py-12">
                        ...
                        <h3 class="mt-2 text-sm font-semibold text-gray-900">Belum ada data sejarah</h3>
                        <p class="mt-1 text-sm text-gray-500">Data sejarah perpustakaan belum tersedia.</p>
                    </div>
                @endforelse
            </div>
        </div>
